...
export const LIMIT_TIME_IN_MINUTES_FOR_ORDER = 60;
...
export const THREE_STEP =
  '5️⃣ НАПИСАТЬ ОТЗЫВ\n' +
  '✔️После получения товара пришлите нам отзыв на согласование. Когда отзыв будет согласован, вам сюда придет сообщение. Обычно мы отвечаем в течение дня.\n\n';
