...
export const MESSAGE_WAITING =
  '❗️Это популярная раздача с ограниченным числом мест. Места могут периодически освобождаться😉';
...
export const FIRST_STEP_OFFER =
  '➡️ Выберите раздачу\nОформить заказ нужно в течение 2️⃣0️⃣-3️⃣0️⃣ минут\n';
...
export const FIRST_STEP_C =
  ...
  'Возврат товара на ПВЗ возможен только по браку, иначе кешбек выплачен не будет \n';
...
export const STEPS = {
  ...
  'Выбор раздачи': {
    step: 0,
    value: 'Выбор раздачи',
    erroText: 'поделиться сюда ссылкой',
    isActive: true,
    typeStep: TYPE_STEP.text,
    stop: false,
  }, // выбор раздачи (web)
  'Артикул правильный': {
    ...
    erroText: 'Поделитесь сюда ссылкой',
    image: '/images/11.jpg',
    isActive: true,
    typeStep: TYPE_STEP.text,
    stop: false,
  ...
  Поиск: {
    step: 0,
    value: 'Поиск',
    erroText: FIRST_STEP_A.toLowerCase(),
    image: '/images/10.jpg',
    isActive: true,
  ...
  Корзина: {
    step: 0,
    value: 'Корзина',
    erroText: FIRST_STEP_CART.toLowerCase(),
    image: '/images/1.jpeg',
    isActive: true,
    typeStep: TYPE_STEP.image,
    stop: false,
